...
$get_category = mysqli_query($mysqli,"select * from  category where category_id='".$category_id."'");
$get_fetch_category = mysqli_fetch_array($get_category);
$image = $get_fetch_category['category_image'];
...
else
{
	...
	$add_category_details= mysqli_query($mysqli, "update category set category_name='".$cat_name."',category_image='".$savdse_image."'where category_id='".$category_id."'");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <div class="portlet-body">
									...
									<?php
										$get_user_details = mysqli_query($mysqli,"select * from category where category_id='".$category_id."'");
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
													<div class="input-group">
														...
														<input type="text" name="name" data-required="1" class="form-control" value="<?php echo $fetch_details['category_name']?>" />
													</div>
												</div>
                                            </div>
													...
													<div class="col-md-9">
														<div class="fileinput fileinput-new" data-provides="fileinput">
															<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																<img src="uploads/<?php echo $fetch_details['category_image']?>" alt="" /> </div>
