...
include ("header.php");
?>
		<div id="page_caption" class="hasbg parallax  withtopbar  " style="background-image:url(http://themegoodsthemes-pzbycso8wng.stackpathdns.com/grandcarrental/demo/wp-content/uploads/2017/01/driver-2.jpg);" >
...
<form class="woocomerce-form woocommerce-form-login login" method="post" style="display:none;">
	...
	<p class="form-row">
		<input type="hidden" id="_wpnonce" name="_wpnonce" value="b89b40b84c" /><input type="hidden" name="_wp_http_referer" value="/grandcarrental/demo/checkout/" />		<input type="submit" class="button" name="login" value="Login" />
		<input type="hidden" name="redirect" value="http://themes.themegoods.com/grandcarrental/demo/checkout/" />
...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="http://themes.themegoods.com/grandcarrental/demo/checkout/" enctype="multipart/form-data">
	...
	<div class="woocommerce-account-fields">
			...
			<div class="create-account">
									<p class="form-row validate-required" id="account_password_field" data-priority=""><label for="account_password" class="">Account password <abbr class="required" title="required">*</abbr></label><input type="password" class="input-text " name="account_password" id="account_password" placeholder="Password"  value=""  /></p>								<div class="clear"></div>
			</div>
...
<div class="woocommerce-additional-fields">
	...
	<tbody>
						...
						<td class="product-name">
							Audi A4&nbsp;							 <strong class="product-quantity">&times; 1</strong>													</td>
						<td class="product-total">
							<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>39,000.00</span>						</td>
					</tr>
						</tbody>
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th>Subtotal</th>
			<td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>39,000.00</span></td>
		</tr>
		...
		<tr class="order-total">
			<th>Total</th>
			<td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>39,000.00</span></strong> </td>
		</tr>
...
<li class="wc_payment_method payment_method_cod">
	...
	<label for="payment_method_cod">
		...
		<input type="hidden" id="_wpnonce" name="_wpnonce" value="e68be1dd2a" /><input type="hidden" name="_wp_http_referer" value="#" />	</div>
</div>
	</div>
