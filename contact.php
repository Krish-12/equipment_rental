...
?>
		...
		<div class="ppb_wrapper hasbg withtopbar">
				...
				<div class="standard_wrapper">
					<div class="page_content_wrapper">
						<div class="inner">
							...
							<h4 class="p1">
								<span class="s1">
									<b>If u have any queries please contact with us</b>
								</span>
							</h4>
			...
			<div  class="one_half_bg withsmallpadding ppb_text_image withbg parallax " style="font-size:18px;background-image:url(images/manhattan-skyline-new-york.jpg);background-position: center center;text-align:center;padding:100px 0 100px 0;color:#ffffff !important;" >
		...
		<div  class="one_half_bg last withsmallpadding ppb_text_image withbg parallax " style="font-size:18px;background-image:url(images/bigstock-Jacksonville-Florida-USA-dow-79804957.jpg);background-position: center center;text-align:center;padding:100px 0 100px 0;color:#ffffff !important;" >
			<div class="overlay_background" style="background:#000000;background:rgb(0,0,0,0.5);background:rgba(0,0,0,0.5);"></div>
			<div class="page_content_wrapper">
				<div class="inner">
					<div style="margin:auto;width:100%">
